...
@implementation YCManagedObject
...
{
    return [NSFetchRequest fetchRequestWithEntityName:[YCManagedObject entityName]];;
}
...
- (void)deleteObjectByPredicate:(NSString *)predicate
{
    ...
    for (YCManagedObject *toDeleteObject in toDeleteObjects) {
